...
CREATE TABLE Admin (
    ...
    INSERT INTO Customer (FirstName, LastName, Nationality, Age, Country, State, City, PostalCode, Email, Phone) VALUES
    ('Dhruv', 'Burada', 'India', 18, 'India', 'Gujarat', 'Rajkot', '360311', 'dburada367@rku.ac.in', '8488997323'),
    ('Archil', 'Gajera', 'India', 25, 'India', 'Gujarat', 'Ahmedabad', '380001', 'agajera@rku.ac.in', '9876543211'),
    ('Paul', 'Lawrence', 'India', 35, 'India', 'Delhi', 'Delhi', '110001', 'paul@rku.ac.in', '9876543212'),
    ('Mayur', 'Rogheliya', 'India', 28, 'India', 'Uttar Pradesh', 'Lucknow', '226001', 'mayur@rku.ac.in', '9876543213'),
    ('Brijesh', 'Sakhiya', 'India', 27, 'India', 'Telangana', 'Hyderabad', '500001', 'brijesh@rku.ac.in', '9876543214');
