  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown"> <!-- Dropdown for "My Profile" -->
          <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <span class="d-none d-lg-inline"><i class="fas fa-user"></i></span> <!-- Show icon and text on LG screens and larger -->
            <span class="d-inline d-lg-none">My Profile</span> <!-- Show text only on smaller screens -->
          </a>
